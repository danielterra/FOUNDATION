...
### Ontology Import Strategy (REVISED 2024-11-25)

**⚠️ Lessons Learned from Initial Implementation:**

After implementing graph visualization with BFO + CCO + Schema.org stack, we discovered critical issues:

<details>
<summary><strong>Issue 1: CCO is too complex and domain-specific</strong> [FAILED]</summary>

- 258+ classes imported
...
**Decision:** Remove CCO entirely from SuperNOVA base ontology

</details>

<details>
<summary><strong>Issue 2: BFO is too abstract for end users</strong> [FAILED]</summary>
...
**Decision:** Remove BFO from SuperNOVA base ontology

</details>

<details>
<summary><strong>Issue 3: Schema.org has similar issues</strong> [FAILED]</summary>
...
**Decision:** Remove Schema.org from SuperNOVA base ontology
...
Layer 2: SuperNOVA Base Ontology (NEW - TO BE CREATED)
  ...
  │  Defines: Minimal set of universal concepts
  │  Examples: Thing, Event, Agent, Resource, Relationship
  │  Purpose: Lightweight foundation that makes sense to users
  │  Principles:
  │    - Maximum 20-30 base classes
...
**Goal**: Design a minimal, user-friendly foundation ontology

**Principles**:
1. **Plain language** - No academic jargon (avoid: Continuant, Occurrent, Endurant)
2. **Practical utility** - Every class must serve a clear purpose
3. **Domain agnostic** - Applicable to personal finance, health tracking, project management, etc.
4. **Extensible** - Easy for users to subclass and adapt
5. **Visual clarity** - Graph visualization must make sense at a glance
